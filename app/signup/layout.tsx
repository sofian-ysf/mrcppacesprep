...
export const metadata: Metadata = {
  ...
  keywords: 'MRCP PACES exam signup, MRCP PACES exam preparation account, MRCP PACES practice questions',
  openGraph: {
    title: 'Sign Up | MRCP PACES Exam Prep',
    description: 'Join 8,500+ medical trainees preparing for their MRCP PACES exam.',
