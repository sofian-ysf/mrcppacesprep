...
export const metadata: Metadata = {
  ...
  description: '2000+ MRCP PACES exam practice questions for 2026 with detailed explanations. SBA, EMQ & calculations. 94% pass rate. 8,500+ candidates. Start preparing today.',
  keywords: [
