...
export const metadata: Metadata = {
  ...
  keywords: 'MRCP PACES exam prep cost, MRCP PACES exam preparation price, MRCP PACES exam subscription, MRCP PACES practice questions price, affordable exam prep',
  openGraph: {
