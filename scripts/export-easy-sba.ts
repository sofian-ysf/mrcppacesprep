/**
 * Export Easy SBA Questions to CSV
 * For manual adjustment to Hard difficulty
 */
...
const OUTPUT_FILE = '/Users/sofianyoussef/Desktop/easy-sba-to-make-hard.csv'
const LIMIT = 850
...
async function main() {
  console.log(`Fetching ${LIMIT} easy SBA questions...`)
  ...
  console.log(`   ${questions?.length} easy SBA questions ready to make hard`)
  console.log(`\n   Change 'difficulty' column from 'Easy' to 'Hard'`)
  console.log(`   Then run: npx tsx scripts/import-fixed-questions.ts /Users/sofianyoussef/Desktop/easy-sba-to-make-hard.csv`)
}
